        ...
        <>
                                    ...
                                    <div className="overflow-hidden aspect-square rounded-main flex flex-col p-4 relative hover:shadow transition bg-lightColor dark:bg-darkColor">
                                        <div className="z-10 h-full flex flex-col justify-center items-center">
                                            ...
                                            <div className="h-[20%] text-center">
                                                <h4 style={{ color: item.accentLight }} className="font-semibold dark:brightness-150">
                                                    {item.label}
                                                </h4>
                                            </div>
                                        </div>
                            ...
                            {mobileTiles.map((item, idx) => (
                                <Link href={item.href} key={idx} className="mt-2">
                                    ...
                                    <div className="text-center mt-2">
                                        <h4 style={{ color: item.accentLight }} className="text-[10px] font-bold dark:brightness-150 leading-tight">
                                            {item.label}
                                        </h4>
                                    </div>
                                </Link>
            ...
            <dialog id="services" className="modal modal-bottom">
                ...
                <div className="modal-box rounded-t-main bg-white dark:bg-black pt-0 px-0">
                    ...
                    <div className="md:block hidden h-[60vh] px-5">
                        <div className="grid grid-cols-6 gap-4 !py-5">
                                        ...
                                        <div className="z-10 w-full h-full flex flex-col justify-between">
                                            <div>
                                                <Image
                                                    ...
                                                    alt={item.label}
                                                />
                                                <h4 style={{ color: item.accentLight }} className="text-sm font-semibold mt-1">
                                                    {item.label}
                                                </h4>
                                            </div>
                                            <div className="flex gap-1 flex-wrap">
                                                {item.subs.map((sub, subIndex) => (
                                                    <p key={subIndex} className="text-[9px] rounded-sm px-[4px] py-[2px] bg-white dark:bg-black truncate">
                                                        {sub}
                                                    </p>
                                                ))}
                                            </div>
                            ...
                            {filtered.length === 0 && (
                                <p className="col-span-4 text-center text-sm text-gray-400">Tidak ada layanan ditemukan</p>
                            )}
                        </div>
                    ...
                    <div className="md:hidden block h-[90vh] px-5">
